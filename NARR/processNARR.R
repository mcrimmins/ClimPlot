...
# monolevel 
#pathNARR<-"/scratch/crimmins/NARR/monolevel/CAPE"
...
writeRaster(x, filename="/scratch/crimmins/NARR/processed/SFCPRES_daily_NARR_WUS_1979_2019.grd", overwrite=TRUE)
